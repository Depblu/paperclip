...
import { printClawithBridgeStreamEvent } from "@paperclipai/adapter-clawith-bridge/cli";
...
const clawithBridgeCLIAdapter: CLIAdapterModule = {
  type: "clawith_bridge",
  formatStdoutEvent: printClawithBridgeStreamEvent,
};
