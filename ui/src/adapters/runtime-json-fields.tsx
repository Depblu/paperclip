...
const { t } = useTranslation();
  ...
  return (
    <Field label={t("misc.runtime_json_fields.runtime_services_json.attr_label", { defaultValue: "Runtime services JSON" })} hint={help.runtimeServicesJson}>
      <textarea
...
const { t } = useTranslation();
  ...
  return (
    <Field label={t("misc.runtime_json_fields.payload_template_json.attr_label", { defaultValue: "Payload template JSON" })} hint={help.payloadTemplateJson}>
      <textarea
