          ...
          <span className="hidden sm:inline-flex h-4 w-4 shrink-0 items-center justify-center self-center">
            {showUnreadDot ? (
              <button
                ...
                aria-label={t("pages.inbox.mark_as_read.attr_aria-label", { defaultValue: "Mark as read" })}
              >
                <span className={cn(
              ...
              <button
                ...
                aria-label={t("pages.inbox.dismiss_from_inbox.attr_aria-label", { defaultValue: "Dismiss from inbox" })}
              >
          ...
          <span className="min-w-0 flex-1">
            <span className="line-clamp-2 text-sm font-medium sm:truncate sm:line-clamp-none">
              {issue ? (
                ...
                <>{t("pages.inbox.failed_run.jsx-text", { defaultValue: "Failed run" })}{linkedAgentName ? ` — ${linkedAgentName}` : ""}</>
              )}
            </span>
        ...
        <div className="hidden shrink-0 items-center gap-2 sm:flex">
          ...
          {!showUnreadSlot && (
            <button
              ...
              aria-label={t("pages.inbox.dismiss.attr_aria-label", { defaultValue: "Dismiss" })}
            >
              <X className="h-4 w-4" />
            </button>
          )}
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            ...
            <span className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-muted-foreground">
              ...
              {requesterName ? <span>{t("pages.inbox.requested_by.jsx-text", { defaultValue: "requested by " })}{requesterName}</span> : null}
              <span>{t("pages.inbox.updated.jsx-text", { defaultValue: "updated " })}{timeAgo(approval.updatedAt)}</span>
            </span>
          </span>
        </Link>
        {showResolutionButtons ? (
          <div className="hidden shrink-0 items-center gap-2 sm:flex">
            <Button
              ...
              disabled={isPending}
            >
              {t("pages.inbox.approve.jsx-text", { defaultValue: "\n              Approve\n            " })}</Button>
            <Button
              variant="destructive"
              size="sm"
              className="h-8 px-3"
              ...
              disabled={isPending}
            >
              {t("pages.inbox.reject.jsx-text", { defaultValue: "\n              Reject\n            " })}</Button>
          </div>
        ) : null}
      </div>
      {showResolutionButtons ? (
      ...
      <div className="flex items-start gap-2 sm:items-center">
        ...
        <div className="flex min-w-0 flex-1 items-start gap-2">
          ...
          <span className="min-w-0 flex-1">
            ...
            <span className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-muted-foreground">
              <span>{t("pages.inbox.requested.jsx-text", { defaultValue: "requested " })}{timeAgo(joinRequest.createdAt)} {t("pages.inbox.from_ip.jsx-text", { defaultValue: " from IP " })}{joinRequest.requestIp}</span>
              {joinRequest.adapterType && <span>{t("pages.inbox.adapter.jsx-text", { defaultValue: "adapter: " })}{joinRequest.adapterType}</span>}
            </span>
          </span>
        </div>
        <div className="hidden shrink-0 items-center gap-2 sm:flex">
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <div className="relative sm:hidden">
          ...
          <Input
            type="search"
            placeholder={t("pages.inbox.search_inbox.attr_placeholder", { defaultValue: "Search inbox…" })}
            value={searchQuery}
          ...
          {tab === "blocked" ? (
            <>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    title={t("pages.inbox.group.attr_title", { defaultValue: "Group" })}
                  >
              ...
              <IssueColumnPicker
                ...
                title={t("pages.inbox.choose_which_inbox_columns_stay_.attr_title", { defaultValue: "Choose which inbox columns stay visible" })}
                iconOnly
              />
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    title={t("pages.inbox.sort.attr_title", { defaultValue: "Sort" })}
                  >
                ...
                <>
                  ...
                  <Dialog open={showMarkAllReadConfirm} onOpenChange={setShowMarkAllReadConfirm}>
                    <DialogContent className="sm:max-w-md">
                      <DialogHeader>
                        <DialogTitle>{t("pages.inbox.mark_all_as_read.jsx-text", { defaultValue: "Mark all as read?" })}</DialogTitle>
                        <DialogDescription>
                          {t("pages.inbox.this_will_mark.jsx-text", { defaultValue: "\n                          This will mark " })}{unreadIssueIds.length} {t("pages.inbox.unread.jsx-text", { defaultValue: " unread " })}{unreadIssueIds.length === 1 ? "item" : "items"} {t("pages.inbox.as_read.jsx-text", { defaultValue: " as read.\n                        " })}</DialogDescription>
                      </DialogHeader>
                      <DialogFooter>
                        <Button variant="outline" onClick={() => setShowMarkAllReadConfirm(false)}>
                          {t("pages.inbox.cancel.jsx-text", { defaultValue: "\n                          Cancel\n                        " })}</Button>
                        <Button
                          onClick={() => {
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            <SelectTrigger className="h-8 w-[170px] text-xs">
              <SelectValue placeholder={t("pages.inbox.category.attr_placeholder", { defaultValue: "Category" })} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="everything">{t("pages.inbox.all_categories.jsx-text", { defaultValue: "All categories" })}</SelectItem>
              <SelectItem value="issues_i_touched">{t("pages.inbox.my_recent_tasks.jsx-text", { defaultValue: "My recent tasks" })}</SelectItem>
              <SelectItem value="join_requests">{t("pages.inbox.join_requests.jsx-text", { defaultValue: "Join requests" })}</SelectItem>
              <SelectItem value="approvals">{t("pages.inbox.approvals.jsx-text", { defaultValue: "Approvals" })}</SelectItem>
              <SelectItem value="failed_runs">{t("pages.inbox.failed_runs.jsx-text", { defaultValue: "Failed runs" })}</SelectItem>
              <SelectItem value="alerts">{t("pages.inbox.alerts.jsx-text", { defaultValue: "Alerts" })}</SelectItem>
            </SelectContent>
          </Select>
          ...
          {showApprovalsCategory && (
            ...
            >
              <SelectTrigger className="h-8 w-[170px] text-xs">
                <SelectValue placeholder={t("pages.inbox.approval_status.attr_placeholder", { defaultValue: "Approval status" })} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="all">{t("pages.inbox.all_approval_statuses.jsx-text", { defaultValue: "All approval statuses" })}</SelectItem>
                <SelectItem value="actionable">{t("pages.inbox.needs_action.jsx-text", { defaultValue: "Needs action" })}</SelectItem>
                <SelectItem value="resolved">{t("pages.inbox.resolved.jsx-text", { defaultValue: "Resolved" })}</SelectItem>
              </SelectContent>
            </Select>
          )}
        </div>
                      ...
                      elements.push(
                        <div key={`today-divider-${group.key}-${index}`} className="my-2 flex items-center gap-3 px-4">
                          ...
                          <span className="shrink-0 text-[11px] font-medium uppercase tracking-wider text-zinc-500">
                            {t("pages.inbox.earlier.jsx-text", { defaultValue: "\n                            Earlier\n                          " })}</span>
                        </div>,
                      );
                    }
        ...
        <>
          ...
          <div>
            <h3 className="mb-3 text-sm font-semibold uppercase tracking-wide text-muted-foreground">
              {t("pages.inbox.alerts.jsx-text", { defaultValue: "\n              Alerts\n            " })}</h3>
                ...
                <div className="group/alert relative flex items-center gap-3 px-4 py-3 transition-colors hover:bg-accent/50">
                  ...
                  >
                    ...
                    <span className="text-sm">
                      ...
                      {dashboard!.agents.error === 1 ? "agent has" : "agents have"} {t("pages.inbox.errors.jsx-text", { defaultValue: " errors\n                    " })}</span>
                  </Link>
                  <button
                    type="button"
              ...
              {showBudgetAlert && (
                <div className="group/alert relative flex items-center gap-3 px-4 py-3 transition-colors hover:bg-accent/50">
                  ...
                  >
                    ...
                    <span className="text-sm">
                      {t("pages.inbox.budget_at.jsx-text", { defaultValue: "\n                      Budget at" })}{" "}
                      <span className="font-medium">{dashboard!.costs.monthUtilizationPercent}%</span>{" "}
                      {t("pages.inbox.utilization_this_month.jsx-text", { defaultValue: "\n                      utilization this month\n                    " })}</span>
                  </Link>
                  <button
                    type="button"
