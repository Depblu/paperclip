  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_320px]">
          <div className="p-6 sm:p-7">
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/25 bg-cyan-500/[0.08] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-cyan-700 dark:text-cyan-300">
              ...
              {t("pages.issuechatuxlab.chat_ux_lab.jsx-text", { defaultValue: "\n              Chat UX Lab\n            " })}</div>
            <h1 className="mt-4 text-3xl font-semibold tracking-tight">{t("pages.issuechatuxlab.issue_chat_review_surface.jsx-text", { defaultValue: "Issue chat review surface" })}</h1>
            <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
              {t("pages.issuechatuxlab.this_page_exercises_the_real_ass.jsx-text", { defaultValue: "\n              This page exercises the real assistant-ui issue chat with fixture-backed messages. Use it to review spacing, chronology, running states, tool rendering, activity rows, queueing, and composer behavior without needing a live issue in progress.\n            " })}</p>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2">
              ...
              <Badge variant="outline" className="rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.18em]">
                {t("pages.issuechatuxlab.assistant_ui_thread.jsx-text", { defaultValue: "\n                assistant-ui thread\n              " })}</Badge>
              <Badge variant="outline" className="rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.18em]">
                {t("pages.issuechatuxlab.fixture_backed_live_run.jsx-text", { defaultValue: "\n                fixture-backed live run\n              " })}</Badge>
            </div>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              >
                ...
                {t("pages.issuechatuxlab.jump_to_live_execution_preview.jsx-text", { defaultValue: "\n                Jump to live execution preview\n              " })}</a>
            </div>
          </div>
          ...
          <aside className="border-t border-border/60 bg-background/70 p-6 lg:border-l lg:border-t-0">
            <div className="mb-4 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-muted-foreground">
              ...
              {t("pages.issuechatuxlab.covered_states.jsx-text", { defaultValue: "\n              Covered states\n            " })}</div>
      ...
      <LabSection
        ...
        title={t("pages.issuechatuxlab.rotating_reasoning_text.attr_title", { defaultValue: "Rotating reasoning text" })}
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
              {t("pages.issuechatuxlab.default_interval_2_2s.jsx-text", { defaultValue: "\n              Default interval (2.2s)\n            " })}</div>
            <RotatingReasoningDemo />
          </div>
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
              {t("pages.issuechatuxlab.fast_interval_1s_stress_test.jsx-text", { defaultValue: "\n              Fast interval (1s) — stress test\n            " })}</div>
      ...
      <LabSection
        ...
        title={t("pages.issuechatuxlab.working_worked_header_verb.attr_title", { defaultValue: "Working / Worked header verb" })}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-3 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
              {t("pages.issuechatuxlab.active_run_shimmer.jsx-text", { defaultValue: "\n              Active run — shimmer\n            " })}</div>
            <div className="flex items-center gap-2.5 rounded-lg px-1 py-2">
              <span className="inline-flex items-center gap-2 text-sm font-medium text-foreground/80">
                <Loader2 className="h-4 w-4 shrink-0 animate-spin text-muted-foreground" />
                <span className="shimmer-text">{t("pages.issuechatuxlab.working.jsx-text", { defaultValue: "Working" })}</span>
              </span>
              <span className="text-xs text-muted-foreground/60">{t("pages.issuechatuxlab.for_12s.jsx-text", { defaultValue: "for 12s" })}</span>
            </div>
          </div>
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            <div className="mb-3 text-[10px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
              {t("pages.issuechatuxlab.completed_run_static.jsx-text", { defaultValue: "\n              Completed run — static\n            " })}</div>
            <div className="flex items-center gap-2.5 rounded-lg px-1 py-2">
              <span className="inline-flex items-center gap-2 text-sm font-medium text-foreground/80">
                <span className="flex h-4 w-4 shrink-0 items-center justify-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500/70" />
                </span>
                {t("pages.issuechatuxlab.worked.jsx-text", { defaultValue: "\n                Worked\n              " })}</span>
              <span className="text-xs text-muted-foreground/60">{t("pages.issuechatuxlab.for_1_min_24s.jsx-text", { defaultValue: "for 1 min 24s" })}</span>
            </div>
          </div>
        </div>
      </LabSection>
      ...
      <LabSection
        ...
        title={t("pages.issuechatuxlab.live_execution_thread.attr_title", { defaultValue: "Live execution thread" })}
      ...
      <LabSection
        ...
        title={t("pages.issuechatuxlab.pending_message_bubble.attr_title", { defaultValue: "Pending message bubble" })}
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <LabSection
          ...
          title={t("pages.issuechatuxlab.durable_comments_and_feedback.attr_title", { defaultValue: "Durable comments and feedback" })}
        ...
        <div className="space-y-6">
          <LabSection
            ...
            title={t("pages.issuechatuxlab.empty_state_and_disabled_compose.attr_title", { defaultValue: "Empty state and disabled composer" })}
          ...
          <Card className="gap-4 border-border/70 bg-background/85 py-0">
            <CardHeader className="px-5 pt-5 pb-0">
              <div className="flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                ...
                {t("pages.issuechatuxlab.review_checklist.jsx-text", { defaultValue: "\n                Review checklist\n              " })}</div>
              <CardTitle className="text-lg">{t("pages.issuechatuxlab.what_to_evaluate_on_this_page.jsx-text", { defaultValue: "What to evaluate on this page" })}</CardTitle>
              <CardDescription>
                {t("pages.issuechatuxlab.this_route_should_be_the_fastest.jsx-text", { defaultValue: "\n                This route should be the fastest way to inspect the chat system before or after tweaks.\n              " })}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 px-5 pb-5 pt-0 text-sm text-muted-foreground">
              <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
                <div className="mb-1 flex items-center gap-2 font-medium text-foreground">
                  ...
                  {t("pages.issuechatuxlab.message_hierarchy.jsx-text", { defaultValue: "\n                  Message hierarchy\n                " })}</div>
                {t("pages.issuechatuxlab.check_that_user_assistant_and_sy.jsx-text", { defaultValue: "\n                Check that user, assistant, and system rows scan differently without feeling like separate products.\n              " })}</div>
              <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
                <div className="mb-1 flex items-center gap-2 font-medium text-foreground">
                  <Sparkles className="h-4 w-4 text-cyan-700 dark:text-cyan-300" />
                  {t("pages.issuechatuxlab.stream_polish.jsx-text", { defaultValue: "\n                  Stream polish\n                " })}</div>
                {t("pages.issuechatuxlab.watch_the_live_preview_for_reaso.jsx-text", { defaultValue: "\n                Watch the live preview for reasoning density, tool expansion behavior, and queued follow-up readability.\n              " })}</div>
            </CardContent>
          </Card>
        </div>
      </div>
