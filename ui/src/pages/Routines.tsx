      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold tracking-tight">
            {t("pages.routines.routines.jsx-text", { defaultValue: "\n            Routines\n          " })}</h1>
          <p className="text-sm text-muted-foreground">
            {t("pages.routines.recurring_work_definitions_that_.jsx-text", { defaultValue: "\n            Recurring work definitions that materialize into auditable execution tasks.\n          " })}</p>
        </div>
        <Button onClick={() => setComposerOpen(true)}>
          <Plus className="mr-2 h-4 w-4" />
          {t("pages.routines.create_routine.jsx-text", { defaultValue: "\n          Create routine\n        " })}</Button>
      </div>
            ...
            <div className="flex items-center gap-1">
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="ghost" size="sm" className="text-xs" title={t("pages.routines.sort.attr_title", { defaultValue: "Sort" })}>
                    <ArrowUpDown className="h-3.5 w-3.5 sm:h-3 sm:w-3 sm:mr-1" />
                    <span className="hidden sm:inline">{t("pages.routines.sort.jsx-text", { defaultValue: "Sort" })}</span>
                  </Button>
                </PopoverTrigger>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="ghost" size="sm" className="text-xs" title={t("pages.routines.group.attr_title", { defaultValue: "Group" })}>
                    <Layers className="h-3.5 w-3.5 sm:h-3 sm:w-3 sm:mr-1" />
                    <span className="hidden sm:inline">{t("pages.routines.group.jsx-text", { defaultValue: "Group" })}</span>
                  </Button>
                </PopoverTrigger>
                <PopoverContent align="end" className="w-44 p-0">
                  <div className="p-2 space-y-0.5">
      ...
      >
        ...
        >
          <div className="shrink-0 flex flex-wrap items-center justify-between gap-3 border-b border-border/60 px-5 py-3">
            <div>
              <p className="text-xs font-medium uppercase tracking-[0.2em] text-muted-foreground">{t("pages.routines.new_routine.jsx-text", { defaultValue: "New routine" })}</p>
              <p className="text-sm text-muted-foreground">
                {t("pages.routines.define_the_recurring_work_first_.jsx-text", { defaultValue: "\n                Define the recurring work first. Default project and agent are optional for draft routines.\n              " })}</p>
            </div>
            <Button
              variant="ghost"
              size="sm"
            ...
            >
              {t("pages.routines.cancel.jsx-text", { defaultValue: "\n              Cancel\n            " })}</Button>
          </div>
          ...
          <div className="min-h-0 flex-1 overflow-y-auto">
            <div className="px-5 pt-5 pb-3">
              <textarea
                ...
                placeholder={t("pages.routines.routine_title.attr_placeholder", { defaultValue: "Routine title" })}
                rows={1}
                value={draft.title}
                onChange={(event) => {
            ...
            <div className="px-5 pb-3">
              <div className="overflow-x-auto overscroll-x-contain">
                <div className="inline-flex min-w-full flex-wrap items-center gap-2 text-sm text-muted-foreground sm:min-w-max sm:flex-nowrap">
                  <span>{t("pages.routines.for.jsx-text", { defaultValue: "For" })}</span>
                  <InlineEntitySelector
                    ...
                    renderTriggerValue={(option) =>
                      option ? (
                        ...
                        <span className="text-muted-foreground">{t("pages.routines.assignee.jsx-text", { defaultValue: "Assignee" })}</span>
                      )
                    }
                    renderOption={(option) => {
                  ...
                  />
                  <span>{t("pages.routines.in.jsx-text", { defaultValue: "in" })}</span>
                  <InlineEntitySelector
                    ...
                    renderTriggerValue={(option) =>
                      option && currentProject ? (
                        ...
                        <span className="text-muted-foreground">{t("pages.routines.project.jsx-text", { defaultValue: "Project" })}</span>
                      )
                    }
                    renderOption={(option) => {
                      if (!option.id) return <span className="truncate">{option.label}</span>;
            ...
            <div className="border-t border-border/60 px-5 py-4">
              <MarkdownEditor
                ...
                placeholder={t("pages.routines.add_instructions.attr_placeholder", { defaultValue: "Add instructions..." })}
                bordered={false}
            ...
            <div className="border-t border-border/60 px-5 py-3">
              <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
                <CollapsibleTrigger className="flex w-full items-center justify-between text-left">
                  <div>
                    <p className="text-sm font-medium">{t("pages.routines.advanced_delivery_settings.jsx-text", { defaultValue: "Advanced delivery settings" })}</p>
                    <p className="text-sm text-muted-foreground">{t("pages.routines.keep_policy_controls_secondary_t.jsx-text", { defaultValue: "Keep policy controls secondary to the work definition." })}</p>
                  </div>
                ...
                <CollapsibleContent className="pt-3">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      <p className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">{t("pages.routines.concurrency.jsx-text", { defaultValue: "Concurrency" })}</p>
                      <Select
