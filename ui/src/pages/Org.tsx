...
export function Org() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("pages.org.org_chart.breadcrumb", { defaultValue: "Org Chart" }) }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message={t("pages.org.select_a_company_to_view_org_c.jsx-text", { defaultValue: "Select a company to view org chart." })} />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message={t("pages.org.no_agents_in_the_organization.jsx-text", { defaultValue: "No agents in the organization. Create agents to build your org chart." })}
        />
      )}
