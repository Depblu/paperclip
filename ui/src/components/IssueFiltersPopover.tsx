...
const { t } = useTranslation();
  ...
  const filterButtonLabel = activeFilterCount > 0
    ? t("components.issuefilterspopover.filters_count.jsx-text", {
      count: activeFilterCount,
      defaultValue: "Filters: {{count}}",
    })
    : t("components.issuefilterspopover.filter.jsx-text", { defaultValue: "Filter" });
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant={buttonVariant} size={iconOnly ? "icon" : "sm"} className={`text-xs ${iconOnly ? "relative h-8 w-8 shrink-0" : ""} ${activeFilterCount > 0 ? "text-blue-600 dark:text-blue-400" : ""}`} title={iconOnly ? filterButtonLabel : undefined}>
          <Filter className={iconOnly ? "h-3.5 w-3.5" : "h-3.5 w-3.5 sm:h-3 sm:w-3 sm:mr-1"} />
          {!iconOnly && <span className="hidden sm:inline">{filterButtonLabel}</span>}
      ...
      >
        <div className="space-y-3 p-3">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium">{t("components.issuefilterspopover.filters.jsx-text", { defaultValue: "Filters" })}</span>
            {activeFilterCount > 0 ? (
              <button
                type="button"
              ...
              >
                {t("components.issuefilterspopover.clear.jsx-text", { defaultValue: "\n                Clear\n              " })}</button>
            ) : null}
          </div>

          <div className="space-y-1.5">
            <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.quick_filters.jsx-text", { defaultValue: "Quick filters" })}</span>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="min-w-0 space-y-3">
              <div className="space-y-1">
                <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.status.jsx-text", { defaultValue: "Status" })}</span>
              ...
              <div className="space-y-1">
                <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.priority.jsx-text", { defaultValue: "Priority" })}</span>
                <div className="space-y-0.5">
            ...
            <div className="min-w-0 space-y-3">
              <div className="space-y-1">
                <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.assignee.jsx-text", { defaultValue: "Assignee" })}</span>
                <div className="max-h-32 space-y-0.5 overflow-y-auto">
                  <label className="flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1 hover:bg-accent/50">
                    ...
                    />
                    <span className="text-sm">{t("components.issuefilterspopover.no_assignee.jsx-text", { defaultValue: "No assignee" })}</span>
                  </label>
                  {currentUserId ? (
                    <label className="flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1 hover:bg-accent/50">
                      <Checkbox
                      ...
                      <span className="text-sm">{t("components.issuefilterspopover.me.jsx-text", { defaultValue: "Me" })}</span>
                    </label>
                  ) : null}
                  {(agents ?? []).map((agent) => (
              ...
              {creatorOptions.length > 0 ? (
                <div className="space-y-1">
                  <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.creator.jsx-text", { defaultValue: "Creator" })}</span>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder={t("components.issuefilterspopover.search_creators.attr_placeholder", { defaultValue: "Search creators..." })}
                  ...
                  <div className="max-h-32 space-y-0.5 overflow-y-auto">
                    {visibleCreatorOptions.length > 0 ? visibleCreatorOptions.map((creator) => {
                      ...
                      <div className="px-2 py-1 text-xs text-muted-foreground">{t("components.issuefilterspopover.no_creators_match.jsx-text", { defaultValue: "No creators match." })}</div>
                    )}
                  </div>
                </div>
              ) : null}
              ...
              {projects && projects.length > 0 ? (
                <div className="space-y-1">
                  <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.project.jsx-text", { defaultValue: "Project" })}</span>
                  <div className="max-h-32 space-y-0.5 overflow-y-auto">
            ...
            <div className="min-w-0 space-y-3">
              {labels && labels.length > 0 ? (
                <div className="space-y-1">
                  <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.labels.jsx-text", { defaultValue: "Labels" })}</span>
                  <div className="max-h-32 space-y-0.5 overflow-y-auto">
                    {labels.map((label) => (
              ...
              {workspaces && workspaces.length > 0 ? (
                <div className="space-y-1">
                  <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.workspace.jsx-text", { defaultValue: "Workspace" })}</span>
                  <div className="max-h-32 space-y-0.5 overflow-y-auto">
              ...
              <div className="space-y-1">
                <span className="text-xs text-muted-foreground">{t("components.issuefilterspopover.visibility.jsx-text", { defaultValue: "Visibility" })}</span>
                <label className="flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1 hover:bg-accent/50">
                  <Checkbox
                    checked={state.liveOnly}
                    onCheckedChange={(checked) => onChange({ liveOnly: checked === true })}
                  />
                  <span className="text-sm">{t("components.issuefilterspopover.live_runs_only.jsx-text", { defaultValue: "Live runs only" })}</span>
                </label>
                {enableRoutineVisibilityFilter ? (
                  <label className="flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1 hover:bg-accent/50">
                    ...
                    />
                    <span className="text-sm">{t("components.issuefilterspopover.hide_routine_runs.jsx-text", { defaultValue: "Hide routine runs" })}</span>
                  </label>
                ) : null}
              </div>
            </div>
