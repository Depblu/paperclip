  ...
  return (
    <div>
      ...
      <div className="rounded-lg border border-border p-4 space-y-3">
        <Field label={t("components.trustpresetsection.trust_preset.attr_label", { defaultValue: "Trust preset" })} hint="Choose how broadly this agent can read and act on Paperclip work objects.">
          <select
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              {boundaryEditable ? (
                ...
                <div className="rounded-md border border-border/70 bg-background/70 p-3 text-foreground">
                  ...
                  <p className="mt-1 text-xs leading-5 text-muted-foreground">
                    {t("components.trustpresetsection.this_policy_has.jsx-text", { defaultValue: "\n                    This policy has " })}{summarizeLowTrustBoundaryTarget(boundary).toLowerCase()} {t("components.trustpresetsection.and_cannot_be_edited_by_the_ce_s.jsx-text", { defaultValue: " and cannot be edited by the CE single-boundary editor.\n                  " })}</p>
                </div>
              )}
              <p className="text-xs text-muted-foreground">
              ...
              >
                <div className="divide-y divide-border/60 text-foreground">
                  ...
                  <PolicyRow label={t("components.trustpresetsection.raw_output.attr_label", { defaultValue: "Raw output" })} value="Quarantined from higher-trust agents" />
                  <PolicyRow label={t("components.trustpresetsection.projects.attr_label", { defaultValue: "Projects" })} value={formatCount(boundary?.projectIds, "project", "projects")} />
                  ...
                  <PolicyRow label={t("components.trustpresetsection.explicit_issues.attr_label", { defaultValue: "Explicit issues" })} value={formatCount(boundary?.issueIds, "issue", "issues")} />
                  <PolicyRow label={t("components.trustpresetsection.allowed_agents.attr_label", { defaultValue: "Allowed agents" })} value={formatCount(boundary?.allowedAgentIds, "agent", "agents")} />
                  ...
                  <PolicyRow label={t("components.trustpresetsection.allowed_secrets.attr_label", { defaultValue: "Allowed secrets" })} value={formatCount(boundary?.allowedSecretBindingIds, "binding", "bindings")} />
